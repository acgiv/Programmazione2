 ...
 * 
 * <p>
 * <b> CLASSE: TestModificaTelevisore </b>
 * <p>
 * * <p> Questa classe si occupa del test di tutti i metodi implementati sulla modifica delle televisioni, così da verificare <br>
...
class TestModificaTelevisore {
	...
	public void test2NumberUsbTelevisoreMedio() {
		...
		System.out.println("Test di'inserimento del numero usb che deve essere maggiore di "
				+ ConstantGlobal.NUMERO_MINIMO_USB + "uguale a " + ConstantGlobal.NUMERO_USB_TV_MEDIO);
	...
	public void test2NumberUsbTelevisoreAvanzato() {
		...
		System.out.println(tvAvanzato + "\n");
		System.out.println("Test di'inserimento del numero usb che deve essere maggiore di "
				+ ConstantGlobal.NUMERO_MINIMO_USB + " e uguale a " + ConstantGlobal.NUMERO_USB_TV_AVANZATO);
