 ...
 * 
 * <p>
 * <b> CLASSE: TestVisualizzaTelevisore </b>
 * <p>
 * * <p> Questa classe si occupa del test di tutti i metodi implementati sulla visualizzazione delle televisioni, così da verificare <br>
...
class TestVisualizzaTelevisore {
	...
	void testvisualizzaNumeroUsbTvTvMedio() {
		System.out.println("test su visualizzazione il numero degli ingressi usb del televisore medio = ad: "+ ConstantGlobal.NUMERO_USB_TV_MEDIO);
		assertEquals(tvMedio.visualizzaNumeroUsb(), ConstantGlobal.NUMERO_USB_TV_MEDIO);
		System.out.println(tvMedio);
	}
