...
abstract class AbstractTelevisore implements Televisore {
	...
	public MarcheTelevisori visualizzaMarca(Televisore tv) {
		MarcheTelevisori result = null;
		switch (scannerTvInstanziata(tv)) {
		case BASE:
			result = ((TelevisoreBase) tv).getMarche();
			break;
		case MEDIO:
			result = ((TelevisoreMedio) tv).getMarche();
			break;
		case AVANZATO:
			result = ((TelevisoreAvanzato) tv).getMarche();
			break;
		}
		return result;
	}
	...
	public double visualizzaAltezza(Televisore tv) {
		...
		switch (scannerTvInstanziata(tv)) {
		case BASE:
			result = ((TelevisoreBase) tv).getAltezza();
			break;
		case MEDIO:
			result = ((TelevisoreMedio) tv).getAltezza();
			break;
		case AVANZATO:
			result = ((TelevisoreAvanzato) tv).getAltezza();
			break;
		}
		return result;
	}
	...
	public double visualizzaLarghezza(Televisore tv) {
		...
		switch (scannerTvInstanziata(tv)) {
		case BASE:
			result = ((TelevisoreBase) tv).getLarghezza();
			break;
		case MEDIO:
			result = ((TelevisoreMedio) tv).getLarghezza();
			break;
		case AVANZATO:
			result = ((TelevisoreAvanzato) tv).getLarghezza();
			break;
		}
		return result;
	}
	...
	public double visualizzaDiagonale(Televisore tv) {
		...
		switch (scannerTvInstanziata(tv)) {
		case BASE:
			result = ((TelevisoreBase) tv).getDiagonale();
			break;
		case MEDIO:
			result = ((TelevisoreMedio) tv).getDiagonale();
			break;
		case AVANZATO:
			result = ((TelevisoreAvanzato) tv).getDiagonale();
			break;
		}
		return result;
	}
	...
	public String visualizzaSeriale(Televisore tv) {
		...
		switch (scannerTvInstanziata(tv)) {
		case BASE:
			result = ((TelevisoreBase) tv).getSeriale();
			break;
		case MEDIO:
			result = ((TelevisoreMedio) tv).getSeriale();
			break;
		case AVANZATO:
			result = ((TelevisoreAvanzato) tv).getSeriale();
			break;
		}
		return result;
	}
	...
	public ConstantGlobal.RISOLUZIONE_TV visualizzaRisluzione(Televisore tv) {
		ConstantGlobal.RISOLUZIONE_TV result = null;
		switch (scannerTvInstanziata(tv)) {
		case BASE:
			result = ((TelevisoreBase) tv).getRisoluzione();
			break;
		case MEDIO:
			result = ((TelevisoreMedio) tv).getRisoluzione();
			break;
		case AVANZATO:
			result = ((TelevisoreAvanzato) tv).getRisoluzione();
			break;
		}
		return result;
	}
	...
	public ConstantGlobal.TIPOLOGIA_SCHERMO visualizzaTipoSchermo(Televisore tv) {
		ConstantGlobal.TIPOLOGIA_SCHERMO result = null;
		switch (scannerTvInstanziata(tv)) {
		case BASE:
			result = ((TelevisoreBase) tv).getTipoSchermo();
			break;
		case MEDIO:
			result = ((TelevisoreMedio) tv).getTipoSchermo();
			break;
		case AVANZATO:
			result = ((TelevisoreAvanzato) tv).getTipoSchermo();
			break;
		}
		return result;
	}
	...
	public ConstantGlobal.TIPOLOGIA_TV visualizzaTipologiaTv(Televisore tv) {
		ConstantGlobal.TIPOLOGIA_TV result = null;
		switch (scannerTvInstanziata(tv)) {
		case BASE:
			result = ((TelevisoreBase) tv).getTipo();
			break;
		case MEDIO:
			result = ((TelevisoreMedio) tv).getTipo();
			break;
		case AVANZATO:
			result = ((TelevisoreAvanzato) tv).getTipo();
			break;
		}
		return result;
	}
	...
	public int visualizzaNumeroUsb(Televisore tv) {
		...
		try {
			...
			case BASE:
				throw new TipologiaException();
			case MEDIO:
				result = ((TelevisoreMedio) tv).getNumber_usb();
				break;
			case AVANZATO:
				result = ((TelevisoreAvanzato) tv).getNumber_usb();
				break;
			}
	...
	public int visualizzaNumeroHdmi(Televisore tv) {
		...
		try {
			...
			case MEDIO:
				throw new TipologiaException();
			case AVANZATO:
				result = ((TelevisoreAvanzato) tv).getNumber_hdmi();
				break;
			}
	...
	public int visualizzaNumeroSmartTv(Televisore tv) {
		...
		try {
			...
			case MEDIO:
				throw new TipologiaException();
			case AVANZATO:
				result = ((TelevisoreAvanzato) tv).getNumber_smartTv();
				break;
			}
		} catch (TipologiaException e) {
			System.err.println("| Errore nella visualizzazione |");
