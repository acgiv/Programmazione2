...
class VisualizzaDipendente {
	...
	void testVisualizzaEtaDipendente() {
		System.out.println("test visualizza l'età del dipendente con campo = " + 17);
		assertEquals(dipendente.VisualizzaEta(), 17);
	}

	@Test
	void test2VisualizzaEtaDipendente() {
		System.out.println("test visualizza l'età del dipendente con campo vuoto");
	...
	void testVisualizzaCittaDipendente() {
		System.out.println("test visualizza la città del dipendente con campo = " + "BARI");
		assertEquals(dipendente.VisualizzaCitta(), "BARI");
	}

	@Test
	void test2VisualizzaCittaDipendente() {
		System.out.println("test visualizza la città del dipendente con campo = " + null);
