...
class TestEliminaDipendente {
	...
	void testEliminaDataNascitaDipendente() {
		try {
			System.out.println("test elimina la data di nascita del dipendente con campo = "+ dipendente.VisualizzaDataNascita());
	...
	void testEliminaNomeAziendaDipendente() {
		try {
			System.out.println("test elimina il nome dell'azienda con campo = "+ dipendente.visualizzaNomeAziendaDipendente());
			assertTrue(dipendente.eliminaCitta());
		} catch (PersonaException e) {
			System.err.println(e.getMessage());
		}	
	...
	void testEliminaEmailAziendaleDipendente() {
		try {
			System.out.println("test elimina l'email del dipendente dell'azienda con campo = "+ dipendente.visualizzaEmailAziendaleDipendente());
	...
	void testEliminaNumeroTelefonoAziendaleDipendente() {
		try {
			System.out.println("test elimina il numero telefonico del  dipendente dell'azienda con campo = "+ dipendente.visualizzaNumeroTelefonoAziendaleDipendente());
	...
	void test2EliminaNumeroTelefonoAziendaleDipendente() {
		try {
			System.out.println("test elimina il numero telefonico del dipendente dell'azienda del dipendente con campo = "+ null);
	...
	void testEliminatipologiaContrattoDipendente() {
		try {
			System.out.println("test elimina la tipologia di contratto del dipendente dell'azienda con campo = "+ dipendente.visualizzatipologiaContrattoDipendente());
	...
	void test2EliminatipologiaContrattoDipendente() {
		try {
			System.out.println("test elimina la tipologia di contratto del dipendente dell'azienda del dipendente con campo = "+ null);
